package LevelEditor 
{
	...
	public class PanelObjects extends Sprite 
	{
		...
		private var _hit6:Sprite = new Sprite();
		private var _hit7:Sprite = new Sprite();
		...
		private function init(e:Event):void 
		{
			...
			Resource.Hit1 = new Bitmap(Resource.AtlasGetBitmap(Resource.Hits, 560, 80, 80, 80, true, 0x000000000000, 0, 0, 80, 80, 0, 0).bitmapData);
			Resource.Hit2 = new Bitmap(Resource.AtlasGetBitmap(Resource.Hits, 560, 80, 80, 80, true, 0x000000000000, 80, 0, 80, 80, 0, 0).bitmapData);
			Resource.Hit3 = new Bitmap(Resource.AtlasGetBitmap(Resource.Hits, 560, 80, 80, 80, true, 0x000000000000, 160, 0, 80, 80, 0, 0).bitmapData);
			Resource.Hit4 = new Bitmap(Resource.AtlasGetBitmap(Resource.Hits, 560, 80, 80, 80, true, 0x000000000000, 240, 0, 80, 80, 0, 0).bitmapData);
			Resource.Hit5 = new Bitmap(Resource.AtlasGetBitmap(Resource.Hits, 560, 80, 80, 80, true, 0x000000000000, 320, 0, 80, 80, 0, 0).bitmapData);
			Resource.Hit6 = new Bitmap(Resource.AtlasGetBitmap(Resource.Hits, 560, 80, 80, 80, true, 0x000000000000, 400, 0, 80, 80, 0, 0).bitmapData);
			Resource.Hit7 = new Bitmap(Resource.AtlasGetBitmap(Resource.Hits, 560, 80, 80, 80, true, 0x000000000000, 480, 0, 80, 80, 0, 0).bitmapData);
			...
			_hit6.addChild(Resource.Hit6);
			_hit6.name = "hit6";
			_hit6.x = 200; _hit6.y = 400;
			_hit6.addEventListener(MouseEvent.CLICK, onMouseClick);
			_hit6.addEventListener(MouseEvent.MOUSE_OUT, onMouseOut);
			_hit6.addEventListener(MouseEvent.MOUSE_OVER, onMouseOver);
			this.addChild(_hit6);
			
			_hit7.addChild(Resource.Hit7);
			_hit7.name = "hit7";
			_hit7.x = 110; _hit7.y = 500;
			_hit7.addEventListener(MouseEvent.CLICK, onMouseClick);
			_hit7.addEventListener(MouseEvent.MOUSE_OUT, onMouseOut);
			_hit7.addEventListener(MouseEvent.MOUSE_OVER, onMouseOver);
			this.addChild(_hit7);
		}
		...
		private function onMouseClick(e:MouseEvent):void 
		{
			...
			if (e.target.name == "hit6")	Resource.SelectObject = "HIT_6";
			if (e.target.name == "hit7")	Resource.SelectObject = "HIT_7";
		}

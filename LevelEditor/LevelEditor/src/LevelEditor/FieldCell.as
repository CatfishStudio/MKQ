	...
	public class FieldCell extends Sprite 
	{
		...
		public function SetObject():void
		{
			if (Resource.SelectObject != "SELECT_NO_OBJECT") {
				...
				if (Resource.SelectObject == "HIT_6" && cellType != "CELL_TYPE_DROP") {
					cellObject = "HIT_6";
					_object.addChild(new Bitmap(Resource.Hit6.bitmapData));
				}
				if (Resource.SelectObject == "HIT_7" && cellType != "CELL_TYPE_DROP") {
					cellObject = "HIT_7";
					_object.addChild(new Bitmap(Resource.Hit7.bitmapData));
				}
